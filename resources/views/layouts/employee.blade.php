...
<body>
    ...
    <script src="{{ asset('spike-bootstrap-free-v2/src/assets/js/sidebarmenu.js') }}"></script>
    <script src="{{ asset('spike-bootstrap-free-v2/src/assets/js/app.min.js') }}"></script>
    <script src="{{ asset('spike-bootstrap-free-v2/src/assets/libs/simplebar/dist/simplebar.js') }}"></script>
