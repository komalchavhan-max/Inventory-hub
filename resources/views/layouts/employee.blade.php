...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        /* Notifications bell override (partial uses Bootstrap classes that need neutralizing) */
        ...
        .action-tile:hover {
            ...
            box-shadow: 0 10px 24px -8px rgba(79,70,229,0.18);
        }
        ...
        .action-tile:hover .tile-cta { gap: 8px; }
        ...
        .action-group { display: inline-flex; align-items: center; gap: 2px; white-space: nowrap; }
        ...
        .action-btn:hover { background: var(--ih-bg); color: var(--ih-text); border-color: var(--ih-border); }
        ...
        .action-btn.cancel:hover  { background: var(--ih-danger-light);  color: var(--ih-danger);  border-color: #fecaca; }
        ...
        .btn-secondary { background: #fff; border-color: var(--ih-border); color: var(--ih-text); }
        .btn-secondary:hover, .btn-secondary:focus { background: var(--ih-bg); border-color: var(--ih-border); color: var(--ih-text); }
        .btn-sm { padding: 6px 12px; font-size: 0.825rem; border-radius: 8px; }

        /* ---------- Forms ---------- */
        .form-label { font-weight: 500; font-size: 0.85rem; color: var(--ih-text); margin-bottom: 6px; }
        ...
        .modal-header { border-bottom: 1px solid var(--ih-border-soft); padding: 16px 20px; }
        .modal-body { padding: 18px 20px; }
        .modal-footer { border-top: 1px solid var(--ih-border-soft); padding: 14px 20px; gap: 8px; }
        ...
        .nav-tabs .nav-link:hover { color: var(--ih-text); background: var(--ih-bg); }
...
<body>
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="{{ route('employee.requests.equipment.form') }}"
               class="nav-link {{ request()->routeIs('employee.requests.equipment.*') ? 'active' : '' }}">
                <i class="bi bi-laptop"></i><span>Request Equipment</span>
            </a>
            <a href="{{ route('employee.requests.exchange.form') }}"
               class="nav-link {{ request()->routeIs('employee.requests.exchange.*') ? 'active' : '' }}">
                <i class="bi bi-arrow-repeat"></i><span>Exchange Equipment</span>
            </a>
            <a href="{{ route('employee.requests.repair.form') }}"
               class="nav-link {{ request()->routeIs('employee.requests.repair.*') ? 'active' : '' }}">
                <i class="bi bi-tools"></i><span>Report Repair</span>
            </a>
            <a href="{{ route('employee.requests.return.form') }}"
               class="nav-link {{ request()->routeIs('employee.requests.return.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('employee.my-requests') }}"
               class="nav-link {{ request()->routeIs('employee.my-requests') ? 'active' : '' }}">
