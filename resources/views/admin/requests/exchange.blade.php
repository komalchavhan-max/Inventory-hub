            ...
            <div class="modal-content">
                <form method="POST">
                    ...
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title">Reject Exchange Request</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <p><strong>Employee:</strong> <span class="employee-name"></span></p>
                        <p><strong>Requested Equipment:</strong> <span class="equipment-name"></span></p>
                        <div class="mb-3">
...
$(document).ready(function() {
    var table = $('#exchangeRequestsTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ url("/admin/requests/exchange-data") }}',
            type: 'GET',
        },
       columns: [
            { data: 'id', name: 'id' },
    ...
    function showRejectModal(id, employeeName, equipmentName) {
        ...
        $template.find('form').attr('action', '/admin/requests/exchange/' + id + '/reject');
        $template.modal('show');
    }
