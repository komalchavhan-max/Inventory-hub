                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="rejection_message" class="form-control" rows="4" required placeholder="Please explain why this exchange request is being rejected..."></textarea>
...
@include('components.data-table.exchange-requests-table')