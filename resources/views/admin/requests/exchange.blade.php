...
<div class="card mb-0">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table align-middle" id="exchangeRequestsTable" style="width:100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Employee</th>
            ...
            <div class="modal-content">
                <form method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title"><i class="bi bi-x-circle text-danger me-2"></i>Reject Exchange Request</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <p class="small text-muted mb-3">
                            <strong class="text-dark">Employee:</strong> <span class="employee-name"></span><br>
                            <strong class="text-dark">Requested Equipment:</strong> <span class="equipment-name"></span>
                        </p>
                        <div>
...
<style>
    ...
    #exchangeRequestsTable td:last-child { text-align: right; }
</style>
@endpush
...
<script>
$(function () {
    var table = $('#exchangeRequestsTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: { url: '{{ url("/admin/requests/exchange-data") }}', type: 'GET' },
        columns: [
            { data: 'id', name: 'id' },
            { data: 'employee_name', name: 'employee_name' },
            { data: 'old_equipment_name', name: 'old_equipment_name' },
            { data: 'requested_equipment_name', name: 'requested_equipment_name' },
            { data: 'exchange_reason', name: 'exchange_reason' },
            { data: 'has_damage', name: 'has_damage' },
    ...
    function showRejectModal(id, employeeName, equipmentName) {
        ...
        $m.find('form').attr('action', '/admin/requests/exchange/' + id + '/reject');
        $m.modal('show');
    }
