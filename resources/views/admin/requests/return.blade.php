...
<div class="card mb-0">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table align-middle" id="returnRequestsTable" style="width:100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Employee</th>
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="rejection_message" class="form-control" rows="4" required placeholder="Please explain why this return request is being rejected..."></textarea>
...
@include('components.data-table.return-requests-table')