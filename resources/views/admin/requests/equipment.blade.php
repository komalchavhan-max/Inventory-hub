...
<div class="card mb-0">
    <div class="card-header d-flex flex-wrap gap-3 justify-content-between align-items-center">
        ...
        <div class="d-flex flex-wrap gap-2">
            ...
            <span class="count-chip tint-success">Fulfilled <span class="count-value" id="fulfilledCount">0</span></span>
            <span class="count-chip tint-danger">Rejected <span class="count-value" id="rejectedCount">0</span></span>
        </div>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table align-middle" id="equipmentRequestsTable" style="width:100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Employee</th>
...
<style>
    ...
    #equipmentRequestsTable td:last-child { text-align: right; }
</style>
@endpush
...
$(function () {
    var table = $('#equipmentRequestsTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: { url: '{{ url("/admin/requests/equipment-data") }}', type: 'GET' },
        columns: [
            { data: 'id', name: 'id' },
        ...
        drawCallback: function () {
            ...
            api.rows().data().each(function (row) {
                ...
                if (row.status && row.status.indexOf('Fulfilled') !== -1) fulfilled++;
    ...
    function showRejectModal(id, employeeName, equipmentName) {
        ...
        $m.find('form').attr('action', '/admin/requests/equipment/' + id + '/reject');
        $m.modal('show');
    }
